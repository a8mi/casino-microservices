...
public class BlackGame implements IRouletteGameLogic{
    ...
    private BlackGame(IRouletteGameStartRequest rouletteGameStartRequest, int ballPosition){
    ...
    public void playGame() {        
        ...
        this.isWin = !redNums.contains(this.ballPosition) && this.ballPosition != 0;
    ...
    public static IRouletteGameLogic create(IRouletteGameStartRequest rouletteGameStartRequest, int ballPosition) {
        BlackGame blackGame = new BlackGame(rouletteGameStartRequest, ballPosition);
        return blackGame;
    }
