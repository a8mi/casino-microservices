...
public record RoulettePlayGameView(Long userId, ERouletteGameType betType, int[] bet, BigDecimal wager,
                                   int ballPosition, boolean isWin, BigDecimal amount) implements IRoulettePlayGameView {
